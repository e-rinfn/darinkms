...
<head>
    ...
    <style>
        ...
        .section-with-bg {
            ...
            background-color: #341EBB; /* Warna latar belakang jika gambar tidak tersedia */
...
<body>
    ...
    <div class="container">
        <div class="mb-4 d-flex justify-content-center">
            <input 
                ...
                placeholder="Cari pelatihan berdasarkan judul atau deskripsi..." 
                onkeyup="filterCards()">
        </div>

        <div id="cardContainer" class="card-container d-flex flex-wrap justify-content-center">
        <?php 
        // Menampilkan data pelatihan dari database
        while ($row = $result_data_pelatihan->fetch_assoc()): 
        ...
        ?>
            ...
            <div class="card m-3" style="width: 300px;" 
                ...
                data-description="<?php echo htmlspecialchars($row['caption_pelatihan']); ?>">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <?php 
                            $max_length = 300; // Batas karakter lebih panjang
                            $caption = htmlspecialchars($row['caption_pelatihan']);
                            // Jika caption lebih panjang dari max_length, tampilkan potongan dengan '...'
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <a href="lihatPelatihan.php?id=<?php echo $row['id']; ?>" class="btn btn-primary rounded-pill w-50" style="background-color: #341EBB">Lihat</a>
                    </div>
                </div>
            </div>
    ...
    <div id="noResults" class="alert alert-warning text-center" style="display: none;">
        Pelatihan tidak ditemukan. Coba kata kunci lain.
    </div>
